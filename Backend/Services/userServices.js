...
//     process.env.JWT_SECRET || "fallbackSecret", // Certifique-se de definir a chave JWT no ambiente
//     { expiresIn: "60s" }
//   );
...
// export default { login, registerUser };  // Certifique-se de exportar as duas funções
